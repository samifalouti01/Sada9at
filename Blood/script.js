document.addEventListener("DOMContentLoaded", () => {
    ...
    announcementForm.addEventListener("submit", function (event) {
        ...
        fetch("https://script.google.com/macros/s/AKfycbzU9jOZpiomp68-dElZ_68VyS-cU5d5yH05R-5795KNwMtdBLLylELeSCH9zFzIP37P/exec", {
            method: "POST",
            headers: {
    ...
    function initializeLanguage(language) {
        const translations = {
            en: {
                ...
                searchPlaceholder: "Searching for the needy...",
                submit: "Submit",
            },
            ar: {
                addAnnouncement: "إضافة إعلان",
                searchPlaceholder: "البحث عن المحتاجين...",
                submit: "إرسال",
            },
        };
        ...
        data.forEach(item => {
            ...
            let cardHTML = `
                <div class="card-text">
                    ...
                    <h5 style="border-radius: 15px; padding: 5px; border: 1.5px solid black; text-align: center;">🧔🏻 ${item.needName}</h5>
